...
Robust to the correspondence path being CSV, XLSX, or an ABS mega‑ZIP bundle
mis-saved as .xlsx. Produces `data_stage/bonds_panel_sa2.parquet` filtered to WA.
"""
