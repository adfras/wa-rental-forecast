...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e() {
        ...
        ~__struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e(void) {
            cleanup();
        }
...

{
    ...
    if (!V1) {
        ...
        if (!success) {
            ...
            PyErr_Clear();
            Py_XDECREF(V1);
            V1 = (PyArrayObject*)PyArray_EMPTY(1, dims, NPY_INT64, 0);
        } else {
            Py_DECREF(success);
        }
    }
...
V1_stride0 = PyArray_STRIDES(V1)[0] / sizeof(npy_int64);
...
V1_iter = (npy_int64*)(PyArray_DATA(V1));
        ...
        for (int ITER_0 = 0; ITER_0<V1_n0; ITER_0++) {
            npy_int64 &V5_i = * ( V5_iter + ITER_0 * V5_jumpx_0 );
npy_int64 &V3_i = * ( V3_iter + ITER_0 * V3_jump0_0 );
npy_int64 &V1_i = * ( V1_iter + ITER_0 * V1_jump0_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e_executor(__struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e *self) {
            return self->run();
        }

        static void __struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e_destructor(PyObject *capsule) {
            __struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e *self = (__struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e* struct_ptr = new __struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e_executor), NULL, __struct_compiled_op_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_meac36e190854cb664b49c423931e56d7240f624a001920335fc4793d4239cf8e(void) {
   import_array();
