...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613() {
        ...
        ~__struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613(void) {
            cleanup();
        }
...
// Op class Join
        ...
        int axis = 0;
        PyArrayObject* arrays[7] = {V15,V13,V11,V9,V7,V5,V3};
        ...
        if (!out_is_valid) {
            ...
            Py_XDECREF(V1);
            PyObject* arrays_tuple = PyTuple_New(7);
            Py_INCREF(V15); PyTuple_SetItem(arrays_tuple, 0, (PyObject*)V15);
Py_INCREF(V13); PyTuple_SetItem(arrays_tuple, 1, (PyObject*)V13);
Py_INCREF(V11); PyTuple_SetItem(arrays_tuple, 2, (PyObject*)V11);
Py_INCREF(V9); PyTuple_SetItem(arrays_tuple, 3, (PyObject*)V9);
Py_INCREF(V7); PyTuple_SetItem(arrays_tuple, 4, (PyObject*)V7);
Py_INCREF(V5); PyTuple_SetItem(arrays_tuple, 5, (PyObject*)V5);
Py_INCREF(V3); PyTuple_SetItem(arrays_tuple, 6, (PyObject*)V3);
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613_executor(__struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613 *self) {
            return self->run();
        }

        static void __struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613_destructor(PyObject *capsule) {
            __struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613 *self = (__struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613* struct_ptr = new __struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8),PyTuple_GET_ITEM(argtuple, 9) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613_executor), NULL, __struct_compiled_op_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_mfec54083f23b25feaa21052617a45fbcb81261bc8b75f412be8b41141084e613(void) {
   import_array();
