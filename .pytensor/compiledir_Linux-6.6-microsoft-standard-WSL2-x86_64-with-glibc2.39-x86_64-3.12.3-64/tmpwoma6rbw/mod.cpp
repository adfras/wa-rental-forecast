...
// For GPU support
    ...
    namespace {
    struct __struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645() {
        ...
        ~__struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645(void) {
            cleanup();
        }
...
npy_bool &V3_i = * ( V3_iter + ITER_0 * V3_jumpx_0 );
...
V17_tmp1 = (npy_float64) _psi(V15_i);
npy_float64 V17_tmp2;
V17_tmp2 = V13_i * V17_tmp1;
npy_float64 V17_tmp3;
V17_tmp3 = (-0.4444444444444444) * V15_i;
npy_float64 V17_tmp4;
V17_tmp4 = V3_i ? V17_tmp3 : (0.0);
npy_float64 V17_tmp5;
V17_tmp5 = V17_tmp4 + V11_i + V17_tmp2 + V9_i + V7_i + V5_i;
npy_float64 V17_tmp6;
V17_tmp6 = V17_tmp5 * V15_i;
npy_float64 V17_tmp7;
V17_tmp7 = (1.0) + V17_tmp6;
V1_i = V17_tmp7;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645_executor(__struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645_destructor(PyObject *capsule) {
            __struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645 *self = (__struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645* struct_ptr = new __struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645_executor), NULL, __struct_compiled_op_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m15a1603863981ad5acadec0263f6ad65eaaa44f9ffe717e57d3a22983fa00645(void) {
   import_array();
