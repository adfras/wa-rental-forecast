...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b() {
        ...
        ~__struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b(void) {
            cleanup();
        }
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b_executor(__struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b *self) {
            return self->run();
        }

        static void __struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b_destructor(PyObject *capsule) {
            __struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b *self = (__struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b* struct_ptr = new __struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b_executor), NULL, __struct_compiled_op_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_mdbc381fa350938cd65cf93964e0d74422a3b1192899125d311ff7a6b80f4390b(void) {
   import_array();
