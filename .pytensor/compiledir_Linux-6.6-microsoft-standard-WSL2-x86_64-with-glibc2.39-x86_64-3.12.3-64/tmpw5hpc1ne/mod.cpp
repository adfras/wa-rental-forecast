...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16 {
        PyObject* __ERROR;
...
PyObject* storage_V9;
        ...
        __struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16() {
        ...
        ~__struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V11, PyObject* storage_V1, PyObject* storage_V3, PyObject* storage_V5, PyObject* storage_V7, PyObject* storage_V9) {
...

{
    ...
    if (!V7) {
        V7 = (PyArrayObject*)PyArray_EMPTY(1,
                                              dims,
                                              NPY_FLOAT64,
                                              0);
    }
        ...
        if (!success) {
            ...
            PyErr_Clear();
            Py_XDECREF(V7);
            V7 = (PyArrayObject*)PyArray_EMPTY(1, dims, NPY_FLOAT64, 0);
        } else {
            Py_DECREF(success);
        }
    }
...
npy_float64 &V9_i = * ( V9_iter + ITER_0 * V9_jump0_0 );
            ...
            
        {
            ...
            {
npy_bool V13_tmp1;
V13_tmp1 = (V11_i > (1e+10));
npy_float64 V13_tmp2;
V13_tmp2 = V13_tmp1 ? (0.0) : (1.0);
npy_float64 V13_tmp3;
V13_tmp3 = V13_tmp1 ? (0.0) : V11_i;
npy_float64 V13_tmp4;
V13_tmp4 = V13_tmp1 ? (1.0) : (0.0);
npy_float64 V13_tmp5;
V13_tmp5 = V13_tmp1 ? (0.0) : (-1.0);
V1_i = V13_tmp1;
V3_i = V13_tmp2;
V5_i = V13_tmp3;
V7_i = V13_tmp4;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16_executor(__struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16 *self) {
            return self->run();
        }

        static void __struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16_destructor(PyObject *capsule) {
            __struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16 *self = (__struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16* struct_ptr = new __struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16_executor), NULL, __struct_compiled_op_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_mb2015a2c673445bf8fabace87c07b78734e3c887d11c085966b9b7c836fb5a16(void) {
   import_array();
