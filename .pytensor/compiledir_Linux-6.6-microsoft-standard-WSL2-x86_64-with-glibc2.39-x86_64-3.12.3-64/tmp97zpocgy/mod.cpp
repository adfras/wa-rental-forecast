...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a {
        PyObject* __ERROR;
...
PyObject* storage_V3;
        ...
        __struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a() {
        ...
        ~__struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V15, PyObject* storage_V13, PyObject* storage_V11, PyObject* storage_V9, PyObject* storage_V7, PyObject* storage_V5, PyObject* storage_V1, PyObject* storage_V3) {
...
V13_stride0 = PyArray_STRIDES(V13)[0] / sizeof(npy_int64);
...
npy_int64 &V13_i = * ( V13_iter + ITER_0 * V13_jump0_0 );
...
V17_tmp1 = (
    V15_i < -37.0 ? exp(V15_i) :
    V15_i < 18.0 ? log1p(exp(V15_i)) :
    V15_i < 33.3 ? V15_i + exp(-V15_i) :
    V15_i
);
...
V17_tmp4 = (
    V17_tmp3 < -37.0 ? exp(V17_tmp3) :
    V17_tmp3 < 18.0 ? log1p(exp(V17_tmp3)) :
    V17_tmp3 < 33.3 ? V17_tmp3 + exp(-V17_tmp3) :
    V17_tmp3
);

npy_float64 V17_tmp5;
V17_tmp5 = -V17_tmp4;
npy_float64 V17_tmp6;
V17_tmp6 = V13_i ? V17_tmp5 : V17_tmp2;
npy_float64 V17_tmp7;
V17_tmp7 = V11_i ? V17_tmp6 : (-INFINITY);
npy_float64 V17_tmp8;
V17_tmp8 = (1.0) - V5_i;
npy_float64 V17_tmp9;
V17_tmp9 = V7_i * V5_i * V17_tmp8;
npy_float64 V17_tmp10;
V17_tmp10 = V17_tmp9 / V17_tmp8;
npy_float64 V17_tmp11;
V17_tmp11 = 1.0 / (1.0 + exp(-V17_tmp3));
npy_float64 V17_tmp12;
V17_tmp12 = V9_i * V17_tmp11;
npy_float64 V17_tmp13;
V17_tmp13 = V17_tmp12 + V17_tmp10;
V1_i = V17_tmp7;
V3_i = V17_tmp13;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a_executor(__struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a *self) {
            return self->run();
        }

        static void __struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a_destructor(PyObject *capsule) {
            __struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a *self = (__struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a* struct_ptr = new __struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a_executor), NULL, __struct_compiled_op_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_ma08c8df2cab8b83c8dfb0757a151d63096dd358cc4764f6856f83f527fe2c05a(void) {
   import_array();
