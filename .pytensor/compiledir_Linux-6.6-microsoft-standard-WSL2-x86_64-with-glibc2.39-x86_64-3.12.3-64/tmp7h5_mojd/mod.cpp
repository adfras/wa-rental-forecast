...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b {
        PyObject* __ERROR;
...
PyObject* storage_V7;
        ...
        __struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b() {
        ...
        ~__struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V9, PyObject* storage_V1, PyObject* storage_V3, PyObject* storage_V5, PyObject* storage_V7) {
...

{
    ...
    if (!V5) {
        V5 = (PyArrayObject*)PyArray_EMPTY(0,
                                              dims,
                                              NPY_BOOL,
                                              0);
    }
        ...
        if (!success) {
            ...
            PyErr_Clear();
            Py_XDECREF(V5);
            V5 = (PyArrayObject*)PyArray_EMPTY(0, dims, NPY_BOOL, 0);
        } else {
            Py_DECREF(success);
        }
    }
...

{
    ...
    if (!V7) {
        V7 = (PyArrayObject*)PyArray_EMPTY(0,
                                              dims,
                                              NPY_FLOAT64,
                                              0);
    }
        ...
        new_dims.len = 0;
        new_dims.ptr = dims;
        PyObject* success = PyArray_Resize(V7, &new_dims, 0, NPY_CORDER);
        if (!success) {
            // If we can't resize the ndarray we have we can allocate a new one.
            PyErr_Clear();
            Py_XDECREF(V7);
            V7 = (PyArrayObject*)PyArray_EMPTY(0, dims, NPY_FLOAT64, 0);
        } else {
            Py_DECREF(success);
        }
    }
...
V11_tmp1 = exp((npy_float64)V9_i);
npy_bool V11_tmp2;
V11_tmp2 = (V11_tmp1 > (0));
npy_bool V11_tmp3;
V11_tmp3 = (V11_tmp1 >= (0.0));
npy_float64 V11_tmp4;
V11_tmp4 = (0.6666666666666666) * V11_tmp1;
npy_float64 V11_tmp5;
V11_tmp5 = V11_tmp4 * V11_tmp4;
npy_float64 V11_tmp6;
V11_tmp6 = (-0.5) * V11_tmp5;
npy_float64 V11_tmp7;
V11_tmp7 = (-0.6312564488800027) + V11_tmp6;
npy_float64 V11_tmp8;
V11_tmp8 = V11_tmp3 ? V11_tmp7 : (-INFINITY);
V1_i = V11_tmp1;
V3_i = V11_tmp2;
V5_i = V11_tmp3;
V7_i = V11_tmp8;
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b_executor(__struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b *self) {
            return self->run();
        }

        static void __struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b_destructor(PyObject *capsule) {
            __struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b *self = (__struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b* struct_ptr = new __struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b_executor), NULL, __struct_compiled_op_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m9045cf4eb66c52ba0f479bd395cdb86e47dd313192475c34aa385c5a3245385b(void) {
   import_array();
