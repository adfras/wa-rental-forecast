...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62 {
        PyObject* __ERROR;
...
PyObject* storage_V5;
        ...
        __struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62() {
        ...
        ~__struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62(void) {
            cleanup();
        }

        int init(PyObject* __ERROR, PyObject* storage_V25, PyObject* storage_V23, PyObject* storage_V21, PyObject* storage_V19, PyObject* storage_V17, PyObject* storage_V15, PyObject* storage_V13, PyObject* storage_V11, PyObject* storage_V9, PyObject* storage_V7, PyObject* storage_V1, PyObject* storage_V3, PyObject* storage_V5) {
...

{
    ...
    if (!V3) {
        ...
        if (!success) {
            ...
            PyErr_Clear();
            Py_XDECREF(V3);
            V3 = (PyArrayObject*)PyArray_EMPTY(0, dims, NPY_BOOL, 0);
        } else {
            Py_DECREF(success);
        }
    }
...
npy_float64& V17_i = *V17_iter;
npy_float64& V15_i = *V15_iter;
...
npy_bool& V3_i = *V3_iter;
                  ...
                  {
npy_float64 V27_tmp1;
V27_tmp1 = exp((npy_float64)V25_i);
npy_bool V27_tmp2;
V27_tmp2 = (V27_tmp1 >= (0.0));
npy_float64 V27_tmp3;
V27_tmp3 = (2.0) * V27_tmp1;
npy_float64 V27_tmp4;
V27_tmp4 = V27_tmp3 * V27_tmp3;
npy_float64 V27_tmp5;
V27_tmp5 = (-0.5) * V27_tmp4;
npy_float64 V27_tmp6;
V27_tmp6 = (0.4673558298198722) + V27_tmp5;
npy_float64 V27_tmp7;
V27_tmp7 = V27_tmp2 ? V27_tmp6 : (-INFINITY);
npy_float64 V27_tmp8;
V27_tmp8 = (5.0) * V9_i;
npy_float64 V27_tmp9;
V27_tmp9 = V27_tmp8 * V27_tmp8;
npy_float64 V27_tmp10;
V27_tmp10 = (-0.5) * V27_tmp9;
npy_float64 V27_tmp11;
V27_tmp11 = V7_i * V7_i;
npy_float64 V27_tmp12;
V27_tmp12 = (-0.5) * V27_tmp11;
npy_float64 V27_tmp13;
V27_tmp13 = (-0.22843915397524506) + V27_tmp12 + V23_i + V21_i + V19_i + V27_tmp10 + V27_tmp7 + V25_i + V17_i + V15_i + V13_i + V11_i;
V1_i = V27_tmp1;
V3_i = V27_tmp2;
V5_i = V27_tmp13;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62_executor(__struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62_destructor(PyObject *capsule) {
            __struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62 *self = (__struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  if (14 != PyTuple_Size(argtuple)){ 
     PyErr_Format(PyExc_TypeError, "Wrong number of arguments, expected 14, got %%i", (int)PyTuple_Size(argtuple));
     return NULL;
  }
  __struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62* struct_ptr = new __struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6),PyTuple_GET_ITEM(argtuple, 7),PyTuple_GET_ITEM(argtuple, 8),PyTuple_GET_ITEM(argtuple, 9),PyTuple_GET_ITEM(argtuple, 10),PyTuple_GET_ITEM(argtuple, 11),PyTuple_GET_ITEM(argtuple, 12),PyTuple_GET_ITEM(argtuple, 13) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62_executor), NULL, __struct_compiled_op_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m712505eae11b4057a07f08b0c8a45b5ea1281ceea809a4f72471b1bb6d9f5a62(void) {
   import_array();
