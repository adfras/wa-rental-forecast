...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7() {
        ...
        ~__struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7(void) {
            cleanup();
        }
    ...
    {Py_XINCREF(py_V3);}
        ...
        goto __label_4;}
            ...
            if (!PyArray_ISALIGNED((PyArrayObject*) py_V3)) {
                ...
                PyErr_Format(PyExc_NotImplementedError,
                             "expected an aligned array of type %ld "
                             "(NPY_INT16), got non-aligned array of type %ld"
                             " with %ld dimensions, with 3 last dims "
                             "%ld, %ld, %ld"
                             " and 3 last strides %ld %ld, %ld.",
                             (long int) NPY_INT16,
        ...
        goto __label_4;}
            ...
            // This is a TypeError to be consistent with DEBUG_MODE
            // Note: DEBUG_MODE also tells the name of the container
            if (PyArray_TYPE((PyArrayObject*) py_V3) != NPY_INT16) {
                PyErr_Format(PyExc_TypeError,
                             "expected type_num %d (NPY_INT16) got %d",
                             NPY_INT16, PyArray_TYPE((PyArrayObject*) py_V3));
                {
        __failure = 4;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7_executor(__struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7_destructor(PyObject *capsule) {
            __struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7 *self = (__struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7* struct_ptr = new __struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7_executor), NULL, __struct_compiled_op_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_m7d136e786335ce3e883a844d033a8900ca585eb05a53655b772588ad7fc5cfe7(void) {
   import_array();
