...
case 1: extract_set_instead_of_inc(object); break;
    ...
    namespace {
    struct __struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54 {
        PyObject* __ERROR;
...
PyObject* storage_V9;
    ...
    PyObject* py_V9;
        ...
        __struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54() {
        ...
        ~__struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54(void) {
            cleanup();
        }
...
// Op class AdvancedIncSubtensor1
        ...
        goto __label_11;}
            ...
            if (PyArray_SHAPE(V1)[0] != 265) {
                PyErr_Format(PyExc_ValueError, "AdvancedIncSubtensor1: first input (x) shape should be 265, got %d", PyArray_SHAPE(V1)[0]);
                {
        __failure = 11;
        if (!PyErr_Occurred()) {
            PyErr_SetString(PyExc_RuntimeError,
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54_executor(__struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54 *self) {
            return self->run();
        }

        static void __struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54_destructor(PyObject *capsule) {
            __struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54 *self = (__struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54* struct_ptr = new __struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54_executor), NULL, __struct_compiled_op_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54_destructor);
...
static struct PyModuleDef moduledef = {
  ...
  "mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54",
  NULL,
  -1,
  MyMethods,
};

PyMODINIT_FUNC PyInit_mc5850bcd775c8ac645023987c87f410ae85c4bb09c6ab5f9d73fa6848da23e54(void) {
   import_array();
